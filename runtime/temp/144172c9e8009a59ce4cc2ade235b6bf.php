<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/wx.jyzf.bio/public/../application/admin/view/dashboard/index.html";i:1746006160;s:67:"/www/wwwroot/wx.jyzf.bio/application/admin/view/layout/default.html";i:1746006160;s:64:"/www/wwwroot/wx.jyzf.bio/application/admin/view/common/meta.html";i:1746006160;s:66:"/www/wwwroot/wx.jyzf.bio/application/admin/view/common/script.html";i:1746006160;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo htmlentities($totaluser ?? ''); ?></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo htmlentities($totaladdon ?? ''); ?></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo htmlentities($attachmentnums ?? ''); ?></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo htmlentities($totaladmin ?? ''); ?></span>
                            ...
                            <div class="card-block">
                                <div class="row row-sm stats-container">
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo htmlentities($todayusersignup ?? ''); ?></div>
                                    ...
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo htmlentities($todayuserlogin ?? ''); ?></div>
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo htmlentities($threednu ?? ''); ?></div>
                                    ...
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo htmlentities($sevendnu ?? ''); ?></div>
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo htmlentities($sevendau ?? ''); ?></div>
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo htmlentities($thirtydau ?? ''); ?></div>
                        ...
                        <div class="panel bg-blue-gradient no-border">
                            <div class="panel-body">
                                ...
                                <div class="panel-content">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h1 class="no-margins"><?php echo htmlentities($totalworkingaddon ?? ''); ?></h1>
                        ...
                        <div class="panel bg-teal-gradient no-border">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo htmlentities($dbtablenums ?? ''); ?></h1>
                        ...
                        <div class="panel bg-purple-gradient no-border">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo htmlentities($attachmentnums ?? ''); ?></h1>
                        ...
                        <div class="panel bg-green-gradient no-border">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo htmlentities($picturenums ?? ''); ?></h1>
