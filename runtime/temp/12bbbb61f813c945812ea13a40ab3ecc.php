<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/wx.jyzf.bio/public/../application/common/view/tpl/dispatch_jump.tpl";i:1746006160;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    ...
    <p class="clearfix">
        ...
        <?php if($url): ?>
            <a id="href" href="<?php echo htmlentities($url ?? ''); ?>" class="btn btn-primary"><?php echo __('Jump now'); ?></a>
        <?php endif; ?>
    </p>
</div>
<?php if($url): ?>
