...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
           <!-- 正确的代码（普通的文本输入框） -->
<input id="c-tg_group_id" data-rule="required" class="form-control" name="row[tg_group_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Group_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-group_name" class="form-control" name="row[group_name]" type="text">
        </div>
    </div>
    <div class="form-group">
