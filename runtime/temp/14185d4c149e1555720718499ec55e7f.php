...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Tg_user_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-tg_user_id" data-rule="required" data-source="tg/user/index" class="form-control selectpage" name="row[tg_user_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-real_name" class="form-control" name="row[real_name]" type="text">
        </div>
    </div>
