<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/www/wwwroot/wx.jyzf.bio/public/../application/admin/view/index/login.html";i:1746006160;s:64:"/www/wwwroot/wx.jyzf.bio/application/admin/view/common/meta.html";i:1746006160;s:66:"/www/wwwroot/wx.jyzf.bio/application/admin/view/common/script.html";i:1746006160;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="login-form">
                    ...
                    <form action="" method="post" id="login-form">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="captcha" class="form-control" placeholder="<?php echo __('Captcha'); ?>" data-rule="<?php echo __('Captcha'); ?>:required;length(<?php echo htmlentities(\think\Config::get('captcha.length') ?? ''); ?>)" autocomplete="off"/>
